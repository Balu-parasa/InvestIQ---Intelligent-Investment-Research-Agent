    ...
    <div className="space-y-6 animate-pulse">
        ...
        {[1, 2].map((i) => (
          <div key={i} className="dashboard-card p-6 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[1, 2, 3, 4].map((j) => (
                <div key={j} className="bg-bg-base border border-border-base rounded-lg p-3 space-y-2">
      ...
      <div className="dashboard-card p-6 md:p-8">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 bg-bg-base border border-border-base rounded-xl p-5 space-y-4">
            <div className="space-y-2">
